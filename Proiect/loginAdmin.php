...
if ($stmt = $con->prepare('SELECT id, parola FROM utilizatori WHERE username = ?')) {
	...
	if ($stmt->num_rows > 0) {
		...
		if (password_verify($_POST['password'], $password)) {
			...
			echo "<p><a href=\"vizualizare_produse.php\">Vizualizare produse</a></p>";
			echo "<p><a href=\"vizualizare_clienti.php\">Vizualizare clienti</a></p>";
			echo "<p><a href=\"vizualizare_cos.php\">Vizualizare cos</a></p>";
} 
       else {
          // password incorrect
